...
class TestRunSecurityScan:
    ...
    def test_scans_all_files(
        ...
        assert mock_gc.triage_with_flash.call_count == 2
    ...
    def test_triggers_deep_scan_for_high_severity(
        ...
        mock_gc.deep_analyze_with_pro.return_value = {
            "findings": [
                {
        ...
        mock_gc.deep_analyze_with_pro.assert_called_once()
    ...
    def test_skips_deep_scan_for_low_severity(
        ...
        mock_gc.deep_analyze_with_pro.assert_not_called()
    ...
    def test_cortex_insights_called_when_findings_exist(
        ...
        mock_gc.triage_with_flash.return_value = {
            "findings": [
                {"severity": "HIGH", "vuln_type": "RCE", "description": "eval", "confidence": 0.9}
            ],
            "file_risk_score": 0.9,
            "summary": "RCE found",
        }
        ...
        mock_rf.format_finding.return_value = {"FINDING_ID": "test"}
        mock_rf.persist_findings.return_value = 1
        mock_cc.get_scan_insights.return_value = {"risk_level": "HIGH", "summary": "Bad"}

        result = scanner.run_security_scan("https://github.com/test/repo")

        mock_cc.get_scan_insights.assert_called_once()
        assert result["insights"] == {"risk_level": "HIGH", "summary": "Bad"}
